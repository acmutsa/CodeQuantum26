	...
	return (
		<div className="relative my-20 h-max">
			...
			<div className="relative flex aspect-[9/17] !max-h-[calc(100vh-7rem)] w-full max-w-[400px] flex-col overflow-hidden rounded-3xl border-2 border-muted bg-background py-[37.5px] dark:border">
				...
				<div className="z-5 absolute inset-0 bg-black/40"></div>

				<div className="relative z-10 flex h-[30%] w-full flex-col items-center pt-2">
					<Image
						src={clerk.imageUrl}
				...
				<div className="event-pass-img relative z-10 flex h-[45%] w-full items-end">
					<div className="relative z-10 grid h-20 w-full grid-cols-2">
				...
				<div className="relative z-10 flex h-[25%] w-full items-center justify-center border-dashed border-muted">
					<Drawer>
