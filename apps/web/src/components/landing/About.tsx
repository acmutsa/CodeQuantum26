									...
									<div className="rounded-3xl border border-white/10 bg-zinc-950/80 p-6 shadow-xl shadow-black/30 md:p-7">
										...
										<div className="mt-4 text-base font-normal leading-relaxed text-white/75">
											...
											<a
												...
												href="https://www.utsa.edu/campusservices/docs/Park-Trans-Map_Main-Campus.pdf"
											>
												Devine Avenue Lot
											</a>{" "}
											and{" "}
										...
										<div className="mt-5 rounded-2xl border border-white/10 bg-black/25 p-4 text-sm leading-relaxed text-white/70">
											...
											Drivers may park without a permit in
											Employee A, Employee B, and unmarked
											Commuter spaces from Friday: 4:30PM
											through 7:00AM the following Monday
										</div>
									</div>
								</RevealCard>
									...
									<div className="relative h-full overflow-hidden rounded-3xl bg-red-600 p-6 shadow-xl shadow-black/30 md:p-7">
										...
										<div className="relative z-10">
											...
											<div className="mt-3 text-sm font-normal leading-relaxed text-white/90">
												Follow the map link above or ask
												a mentor at check-in, and we’ll
												get you hacking in no time!
											</div>
		...
		<div className="group relative">
			<div className="relative overflow-hidden rounded-[26px] border border-white/10 bg-zinc-950/90 p-4 shadow-[0_22px_60px_rgba(0,0,0,0.35)] md:p-5 lg:p-6">
				<div className="pointer-events-none absolute inset-0 opacity-60">
					...
					<div className="absolute -bottom-28 -right-28 h-72 w-72 rounded-full bg-white/5 blur-3xl" />
				</div>
		...
		>
			<div className="relative overflow-hidden rounded-3xl border border-white/10 shadow-[0_30px_70px_rgba(0,0,0,0.55)]">
				...
				>
					...
					<div
						className="pointer-events-none absolute inset-x-0 top-0 h-[14px] opacity-90 blur-[0.2px] md:h-4"
						style={curbStripeStyle}
					/>
					<div
						className="pointer-events-none absolute inset-x-0 bottom-0 h-[14px] opacity-90 blur-[0.2px] md:h-4"
						style={curbStripeStyle}
					/>
...
function FaqItem({
	...
	return (
		<button
			...
			className={cn(
				"group rounded-2xl border border-white/10 bg-white/[0.04] p-4 text-left",
		...
		>
			<div className="flex items-start justify-between gap-3">
				...
				<div
					className={cn(
						"mt-0.5 grid h-8 w-8 place-items-center rounded-full border border-white/10 bg-black/35",
