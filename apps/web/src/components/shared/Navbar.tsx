...
export default async function Navbar({ className }: NavbarProps) {
	...
	return (
		<div className="fixed top-0 z-50 w-screen">
				<div
					className={cn(
						`relative top-0 z-50 h-16 w-screen bg-transparent ${racingSansOne.variable}`,
						className,
					)}
				>
				<div className="mx-auto grid h-full w-full max-w-7xl grid-flow-col grid-cols-2 px-2 sm:px-6 lg:max-w-full lg:px-8">
					...
					>
						<div className="relative [filter:drop-shadow(0_1px_2px_rgba(255,255,255,0.9))_drop-shadow(0_0_10px_rgba(255,255,255,0.5))]">
							<Image
								src={c.icon.svg}
